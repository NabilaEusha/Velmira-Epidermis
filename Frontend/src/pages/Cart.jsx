      ...
      <div className="flex gap-8">
        ...
        <div className="flex-1 bg-white shadow-md rounded-lg p-6">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <button
              className="bg-[#555114] w-[200px] text-white p-3 mt-4 rounded-md font-semibold cursor-pointer"
        ...
        <div className="w-80 bg-white shadow-md rounded-lg p-6">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <button
              className="bg-[#555114] text-white p-3 w-full rounded-lg font-semibold cursor-pointer"
